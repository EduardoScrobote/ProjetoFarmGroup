                ...
                <div className="flex justify-evenly bg-gradient-to-t from-transparent to-sky-300 shadow-black shadow-xl w-1/6 rounded-3xl border border-black pb-2 mt-48">
                    <div className="text-left">
                        ...
                        <div className="flex justify-center mb-6">
                            <button className="mt-6 w-44 bg-gradient-to-t from-yellow-500 to-yellow-300 border border-black rounded-xl hover:p-1 duration-300">Cadastre-se</button>
                        </div>
                        <p>Já possui uma conta? <Link to='/login' className="hover:underline hover:decoration-solid hover:cursor-pointer">Faça Login</Link></p>
                    </div>
                </div>
            </div>
        </div>
